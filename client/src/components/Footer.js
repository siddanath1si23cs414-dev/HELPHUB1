        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Help Hub</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Connecting people who need help with volunteers in their community. 
              Making assistance accessible, reliable, and secure.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/request" className="text-gray-400 hover:text-white transition duration-200">Request Help</a></li>
              <li><a href="/volunteer/register" className="text-gray-400 hover:text-white transition duration-200">Become Volunteer</a></li>
              <li><a href="/volunteer/login" className="text-gray-400 hover:text-white transition duration-200">Volunteer Login</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Help Hub. All rights reserved.
            </p>
